...
set(TensorRT_WELL_KNOWN_ROOT "C:/Program Files/NVIDIA Corporation/TensorRT-10.9.0.34")
...
if(WIN32)
    _tensorrt_find_dll(TensorRT_DLL "nvinfer_${TensorRT_VERSION_MAJOR}.dll" nvinfer_10.dll)
endif()
...
if(TensorRT_FIND_COMPONENTS)
    ...
    if("OnnxParser" IN_LIST TensorRT_FIND_COMPONENTS)
        ...
        if(WIN32)
            _tensorrt_find_dll(
                    TensorRT_OnnxParser_DLL "nvonnxparser_${TensorRT_VERSION_MAJOR}.dll" nvonnxparser_10.dll)
        endif()
    endif()
    ...
    if("Plugin" IN_LIST TensorRT_FIND_COMPONENTS)
        ...
        if(WIN32)
            _tensorrt_find_dll(
                    TensorRT_Plugin_DLL "nvinfer_plugin_${TensorRT_VERSION_MAJOR}.dll" nvinfer_plugin_10.dll)
        endif()
    endif()
endif()
